...
def get_images(path):
    ...
    for img in os.listdir(path):
        fullPath_train_ct = os.path.join(path, img)         # full path of each image
        image_paths.append(fullPath_train_ct)

    return image_paths


# IMAGE_PATHS = download_images()
IMAGE_PATHS = get_images("../Input_Images")
...
for image_path in IMAGE_PATHS:
    ...
    print('Done')
    plt.imsave(f"../Output_Results/Image{i}.jpg", image_np_with_detections)
    i += 1
